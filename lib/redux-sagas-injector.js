...
exports.SagaManager = exports.CANCEL_SAGAS_HMR = undefined;
...
var _reduxReducersInjectorForked = require('redux-reducers-injector-forked');
...
function createInjectSagasStore(rootSaga, initialReducers) {
    ...
    store = _reduxReducersInjectorForked.createInjectStore.apply(undefined, [initialReducers].concat(args));
    store.injectedSagas = [];
...
function createInjectSagasMiddleware(options) {
    sagaMiddleware = (0, _reduxSaga2.default)(options);
